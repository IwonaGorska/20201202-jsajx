...
// W aktualnej fazie 2 jest propozycja utworzenia klasycznych pól prywatnych,
// Jednak żeby działało to wstecznie kompatybilnie - zaproponowano "dość dziwny" syntax:
// 4) hot news
class Person {
	name = 'John';
